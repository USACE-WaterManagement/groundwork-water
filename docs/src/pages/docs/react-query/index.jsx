...
export default function Docs() {
  return (
    ...
    >
      ...
      <Alert
        ...
        message={
          <span>
            ...
            <b>@usace-watermanagement/groundwork-water</b> package. You will need to
      ...
      <Text>
        Create a new instance of the <b>QueryClient</b> and pass in the default options.
        Note: The <code className="font-bold"> refetchOnWindowFocus</code> option is set
        to true by default.
      </Text>
      <Alert
        status="warning"
        ...
        message={
          <span>
            Use the <b>refetchOnWindowFocus: true</b> option sparingly, as it will cause{" "}
            <em>EVERY</em> query to be re-run every time the user navigates back to the
            tab or window.
          </span>
        }
      />
  ...
  defaultOptions: {
    queries: {
      ...
      <Text>
        ...
        <code className="font-bold"> queryClient</code> instance you created above.
      </Text>
      <Code className="gw-block gw-p-1 gw-px-2" language="jsx">
  ...
  <React.StrictMode>
    <ReduxBundlerProvider store={store}>
      ...
      <Text>
        Make sure to import style.css from Groundwork into your top-level component
        (i.e. App.jsx), then go build stuff with the components
      </Text>
